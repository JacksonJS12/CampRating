...
[Route("Review")]
public class CampReviewController : BaseController
{
    private readonly IReviewService _reviewService;
    private readonly ICampService _campService;

    public CampReviewController(IReviewService reviewService, ICampService campService)
    {
    ...
    public async Task<IActionResult> All(string campId)
    {
        ...
        return View("~/Views/Review/All.cshtml", viewModel);
    }
